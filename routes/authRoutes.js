...
const { createUser, getUser, loginUser, getAllUser, deleteUser, updateUser, blockUser, unblockUser, handleRefreshtoken, logout, updatePassword, forgotPasswordToken, resetPassword, loginAdmin, saveAddress, userCart, getUserCart, emptyCart, applyCoupon, createOrder, updateOrderStatus, getAllOrders,  getOrder, getUserOrders, orderSingleProduct, cancelOrder } = require("../controller/userCtrl");
...
authRouter.put("/cancel-order/:id", cancelOrder)
